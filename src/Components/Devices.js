    ...
    <div>
        ...
        <div className="carousel-inner">
          <div className="carousel-item active image1">
            <img src="  https://plus.unsplash.com/premium_photo-1683531060518-ce77d964c6d2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8ZGV2aWNlc3xlbnwwfHwwfHx8MA%3D%3D" className="d-block w-100" alt="..." />
          </div>
          ...
          <div className='d-flex flex-row '>
            <div className="card super-card m-2">
              ...
              <div className="card-body">
                ...
                <button className='jiomart m-2'> Buy on jiomart</button>
                <button  className='larn'> Larn more</button>
              </div>
            </div>
            <div className="card super-card m-2">
