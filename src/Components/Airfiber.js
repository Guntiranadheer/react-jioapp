  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className=''>
          <h1 className='text-center'> Discover the benifits of digital tv</h1>
          <div className=''>
            
            <video className='watch' src=" https://jep-asset.akamaized.net/cms/assets/home/watch-missed.mp4"/>
            <div className='shows'>
              <h4>800+degital tv channels</h4>
              <p> enjoy the top tv shows ,movies, news,sports</p>
           </div>
          ...
          <div className=''>
            ...
            <video className='watch1' src=" https://jep-asset.akamaized.net/cms/assets/home/watch-missed.mp4"/>
