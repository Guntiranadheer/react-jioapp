...
function Business() {
    ...
    <div>
      ...
      <div>
        ...
        <div className="container text-center ">
          ...
          <div className='d-flex flex-row '>
            <div className="card super-card m-2">
              <img src="  https://jep-asset.akamaized.net/cms/assets/business/services/cards-oct-2024/connectivity-oct-2024.webp" className="wow-image" alt="..." />
              <div className="card-body">
                <p className="card-text">
                  <h4 className='para'> Stay connected when aboard</h4>
                  <p className='para'>carries jio benifits wherever you go international roaming plans</p>
            ...
            <div className="card super-card m-2">
              <img src="https://jep-asset.akamaized.net/cms/assets/business/services/cards-oct-2024/cloud-oct-2024.webp" className="wow-image" alt="..." />
              <div className="card-body">
                <p className="card-text">
                  <h4 className='para'> Stay connected when aboard</h4>
                  <p className='para'>carries jio benifits wherever you go international roaming plans</p>
            ...
            <div className="card super-card m-2">
              <img src=" https://jep-asset.akamaized.net/cms/assets/business/services/cards-oct-2024/voice-collaboration-oct-2024.webp" className="wow-image" alt="..." />
              <div className="card-body">
                <p className="card-text">
                  <h4 className='para'> Stay connected when aboard</h4>
                  <p className='para'>carries jio benifits wherever you go international roaming plans</p>
  ...
  <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4 ">
    <div className="card col m-4">
      <h4> BSFI</h4>
      <p> Drive digital transformation for banks and finiancial institutions</p>
    </div>
    <div className= "card col m-4">
    <h4> BSFI</h4>
    <p> Drive digital transformation for banks and finiancial institutions</p>
